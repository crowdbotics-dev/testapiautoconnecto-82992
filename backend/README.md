...
## Project Structure
    ...
    ├── testapiautoconnecto_82992  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_82992`
...
2. Clone this repo and `cd testapiautoconnecto_82992`
